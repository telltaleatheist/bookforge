...
- **02:00 Foundry drove the lease end to end on the Mac** (their hand-run of the app's
  ...
  lease and a load-model both `409 leased` naming the holder → the built engine's
