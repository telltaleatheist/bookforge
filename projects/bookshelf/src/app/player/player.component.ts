...
export class PlayerComponent implements OnInit, OnDestroy {
  ...
  private static readonly CAT_FACTS = [
    ...
    "A cat's field of view is about 200 degrees, to a human's 180.",
    'A cat needs roughly one-sixth the light a human does: the tapetum lucidum bounces every photon back through the retina a second time.',
    "A cat's visual acuity is around 20/100 — it has to stand at six metres to see what you see at twenty.",
    'Cats are dichromats — two kinds of cone, strongest in the blues and violets, weakest at the red end.',
    'A cat can place a sound to within 8 cm at a distance of one metre.',
    'The muzzle carries about 24 movable whiskers in four rows; each is twice as thick as ordinary fur and rooted three times deeper.',
    'Whisker signals land in the barrel cortex, a patch of brain that builds a three-dimensional map of whatever the cat just brushed past.',
    'A cat has 45 to 200 million odour-sensitive cells in its nose; a human makes do with about 10 million.',
    "Cats have about 470 taste buds to a human's 9,000, and the umami receptors among them are tuned to the compounds that make tuna taste like tuna.",
    'Five toes in front, four behind: a standard cat comes with 18.',
    'Instead of a fovea, a cat has a visual streak — a horizontal band of sharp vision, aimed exactly where the horizon is.',
    'Scratching is scent-marking as much as manicure: the glands are between the toes.',
    'Researchers have catalogued up to 21 distinct cat vocalizations.',
    'Mildred Moelk published the first phonetic study of cat sounds in 1944, sorting 16 patterns by what the mouth was doing.',
    'Kittens mew at their mothers and mostly give it up by four or five months old.',
    "The chirr, or trill, is a mother's call to her kittens — a cat who trills at you is using the family channel.",
    'Cats fold a high, urgent cry into the purr when they want feeding; Karen McComb named it the solicitation purr in 2009.',
    'Cats also purr when hurt, frightened or in labour, so a purr is self-soothing before it is applause.',
    'Only the purring cats have a fully ossified hyoid bone; lions and tigers roar instead, and the snow leopard purrs anyway.',
    'Kneading is nursing behaviour that simply never switched off.',
    'A tail carried straight up is a confident hello, and the little hook at the tip is the invitation.',
    'Cats are crepuscular — built for dawn and dusk, which is also when they decide to run the hallway.',
    "Cats know their own names: a 2019 study by Atsuko Saito's team found them turning ears and heads to their own name and not to other cats'.",
    "A kitten's socialization window is three to nine weeks, and how it is handled then decides how it takes strangers for life.",
    'Cats flunk the string-pulling test: they do not reason about cause and effect the way we do.',
    'About two-thirds of cats respond to catnip; the other third feel nothing whatsoever.',
    'The catnip response runs 5 to 15 minutes and then the nose fatigues — the toy has not stopped working, the cat has.',
    'Silver vine, Actinidia polygama, works on many of the cats catnip misses.',
    'Leopards, cougars, servals and lynxes react to catnip much the way a house cat does.',
    'Cats are obligate carnivores: a single meal lacking arginine can be fatal.',
    'A cat carries roughly 250 million neurons in its cerebral cortex, inside a brain of about 25 to 30 grams.',
    'A male tortoiseshell turns up about once in 3,000 cats, and is usually XXY.',
    'Tortoiseshell patchwork is X-inactivation made visible: every cell shuts off one X chromosome at random, very early on.',
    'The gene behind orange cats was only pinned down in 2025 — a deletion near ARHGAP36 on the X chromosome.',
    'The tabby gene is Taqpep: one amino-acid substitution turns thin mackerel stripes into broad blotched whorls, and the same gene makes the king cheetah.',
    'The blotched tabby is a medieval arrival, so a swirl-sided cat is a relatively modern design.',
    'The white-coat KIT allele overrides every other colour gene, and brings blue eyes and a real risk of deafness with it.',
    'Siamese kittens are born cream-white: the pigment enzyme only works where the body runs cool, so the points arrive later.',
    "Thailand's Tamra Maew manuscripts describe Siamese-type cats centuries before the West saw one; the first breeding pair, Pho and Mia, reached Britain in 1884.",
    'The first Siamese in America was a diplomatic gift to President Rutherford B. Hayes in 1878.',
    'Two copies of the Manx taillessness gene are lethal before birth, so no Manx has ever carried both.',
    'Maine made the Maine Coon its official state cat in 1985.',
    'Cosey, a Maine Coon, took Best in Show at the first great American cat show — Madison Square Garden, 1895.',
    'Stewie, a Maine Coon from Nevada, measured 123 cm from nose to tail tip.',
    'Creme Puff of Austin, Texas lived 38 years and 3 days.',
    'The loudest purr on record is 67.8 decibels, set by Smokey and matched by Merlin — conversation volume, from a cat.',
    "Ernest Hemingway's house in Key West keeps about 50 descendants of his cats, roughly half of them six-toed.",
    'The record for toes on a single cat is 29, held by Erebus of Wisconsin.',
    "Extra toes cluster along North America's East Coast and in southwest England: the old Boston shipping routes, drawn in paws.",
    'Félicette rode a Véronique rocket to about 150 km on 18 October 1963 and was recovered 13 minutes later — the first cat in space.',
    'Chester, a Siamese, co-authored a 1975 Physical Review Letters paper as F. D. C. Willard, because his physicist had written the whole thing as "we".',
    'Trim was born at sea, fell overboard, climbed back aboard up a rope, and then circumnavigated Australia with Matthew Flinders from 1801 to 1803.',
    'Larry has been Chief Mouser to the Cabinet Office at 10 Downing Street since February 2011, outlasting prime ministers.',
    'Tama was stationmaster of Kishi Station in Wakayama from 2007 until her death in 2015; one study credited her fame with 1.1 billion yen to the local economy.',
    'Every domestic cat descends from a single wildcat, Felis lybica, of the Near East and North Africa.',
    'The word cat runs back through Old English catt to Late Latin cattus, first written down in the 6th century.',
    'A cat was a "puss" from the 1500s, and a kitten was once a catling.',
    "Mafdet, not Bastet, was Egypt's first cat-headed deity, guarding pharaohs in the First Dynasty.",
    'Excavators at Beni Hasan turned up over 200,000 mummified animals in the 1880s, most of them cats.',
    'Diodorus Siculus records a Roman lynched in Egypt around 60 BC for killing a cat.',
    'The maneki-neko raises its left paw for customers and its right paw for money; the earliest written record of one dates to 1852.',
    'Gotoku-ji temple credits a beckoning cat with waving Lord Ii Naotaka out of a thunderstorm in the 1620s, which is why the place is now full of them.',
    'Domestic cats still carry 9.6 million single-nucleotide variants — serious selective breeding is barely two centuries old.',
    'There are roughly 600 million domestic cats alive, about 400 million of them in Asia.',
    'Erwin Schrödinger put a cat in a box in 1935 to argue that the physics was absurd, not the cat.',
    "T. S. Eliot wrote Old Possum's Book of Practical Cats as letters to his godchildren; published in 1939, it became Cats in 1981 and, for a while, the longest-running show on Broadway.",
  ];
