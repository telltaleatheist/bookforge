/**
 * icdar-to-pairs — convert the ICDAR post-OCR competition data into ocr pairs.
 *
 *   node tools/foundry-ocr/icdar-to-pairs.mjs [--out ~/…/ocr/pairs] [--dry-run]
 *     [--sets eng_monograph]
 *
 ...
 * there; and at sentence ends once a segment is long enough, because ocr's
