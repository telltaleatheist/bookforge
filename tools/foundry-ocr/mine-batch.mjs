 ...
 *
 *   node tools/foundry-ocr/mine-batch.mjs [--pages 20] [--limit 60] [--dry-run]
 ...
 * twice. §4 measured it on blocks: `table` had 431 examples in 4 books and
 * scored F1 0.00 while `chapter` had 398 in 13 books and scored 0.66. ocr's
...
console.log(`next: node tools/foundry-ocr/build-corpus.mjs --pairs "${outDir}/*.pairs.jsonl" --stats ${outDir}`);
