"""Ground truth for rubric v5's `continues` head, mined from the PDF's own text layer.
...
decide the bit — the same discipline as tools/galley/align-pairs.py. OCR text is
...
Usage:
  python3 tools/rubric/continues-truth.py <bookdir> <out.jsonl> [--stats out.json]
