...
export class PdfPickerComponent implements OnInit {
   ...
   *
   * (Two parallel builds of this queue existed for one evening — this stacked
   * form and a front-only pure-module form. This one won because the template
   * shows the whole stack with per-row dismissal.)
   */
