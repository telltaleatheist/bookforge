 ...
 *
 * Ported from the bookshelf web player so the desktop players can share the
 * exact same look. Keep the two sets in sync when adding icons.
 */
@Component({
  selector: 'app-icon',
  standalone: true,
...
export class IconComponent {
  ...
  private static readonly PATHS: Record<string, string> = {
    ...
    // Crescent moon — sleep timer / end of chapter.
