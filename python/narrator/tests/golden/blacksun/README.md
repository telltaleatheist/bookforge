...
| source project (Z:) | `Z:\<library>\projects\Black_Sun_-_Aryan_Cults,_Esoteric_Nazism,_and_the_Politics_of_Identity_-_Nicholas_Goodrick-Clarke_(2009)` |
...
python -m narrator.tests.golden_tools.build_fixture \
    ...
    --source-project "Z:\<library>\projects\Black_Sun_-_Aryan_Cults,_Esoteric_Nazism,_and_the_Politics_of_Identity_-_Nicholas_Goodrick-Clarke_(2009)" \
    --e2a-commit 9daab0ba9360b4e9e8d538bd6da9b713fed2de21
```
