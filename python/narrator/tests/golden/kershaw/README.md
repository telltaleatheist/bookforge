...
| source project (Z:) | `Z:\<library>\projects\Working_Towards_The_Fuhrer_-_Ian_Kershaw_(1993)` |
...
python -m narrator.tests.golden_tools.build_fixture \
    ...
    --source-project "Z:\<library>\projects\Working_Towards_The_Fuhrer_-_Ian_Kershaw_(1993)" \
    --e2a-commit 9daab0ba9360b4e9e8d538bd6da9b713fed2de21
```
