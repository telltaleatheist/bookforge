...
| Source sha | **ae1d0fa** — *A placement reads the server's chat admission AFTER its load* (was 0946be6). **Source only — BookForge was running a cleanup; `npm run build` here after it quits.** |
