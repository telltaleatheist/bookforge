...
| Source sha | **9c2aa68** — *n15: the light gate — refuse only a reading that changes what is already spoken as printed* (was 2c5edfc; only `engine/foundry-engine.cjs` moved) |
