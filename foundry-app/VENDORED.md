...
| Source sha | **ee3fdc9** — *Restore the model triage, and remove the deterministic gate* (app/ is byte-identical to 0eb12de's; c3df021 was vendored as 57b37b52 and reverted) |
