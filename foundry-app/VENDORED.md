...
| Source sha | **19fa7a9** — *Categorize: the category definitions move into the header, each question shrinks 197 → ~76 tokens* (was 7912022) |
...
| Copied on | 2026-09-19 (five times: 3738c01, 3436fc5, 806d44b, f349771, ca4754c), 2026-09-20 (98a4344, 9e0b27d, dccc144, 7b98004, cc5fc5b, 93010d8, 77e1d6d) 2026-09-21 (753dca8, 3e26e53, f9bebb6, 95593b0, 8ee48b7) and 2026-09-22 (7185764, 7912022, 19fa7a9) |
| Copied by | Mechanical source sync, verified against Foundry `19fa7a9:app/` (`diff -rq`, clean but for this file, `IPC-CHANNELS.md` and `.gitignore` — see below); details below |
