...
| Source sha | **f57402c** — *n16: years lean year, other dates from knowledge, every ruler's numeral, transl./ed., month-first ranges* (was 9c2aa68; only `engine/foundry-engine.cjs` moved) |
