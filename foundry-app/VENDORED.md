...
| Source sha | **f168809** — *n13: clean-text sends one short prompt, never-change rules first; markup stays unedited with the gate off* (was 571d57f; only `engine/foundry-engine.cjs` moved) |
