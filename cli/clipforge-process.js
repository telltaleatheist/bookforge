...
TRAINING_HELP.deploy = [
  ...
  '',
  '  RECORDING THE CHART IS PART OF DEPLOYING. Owen 2026-09-09: "part of deployment is recording the',
  '  chart/spread that we generate. and we use the cleanest unbroken band available." So --apply appends',
  '  the failure curve for that run to electron/data/higgs-safe-bands-evidence.md beside the config. A band',
  '  no curve beside it cannot be argued with later. THE BAND IS THE CLEANEST UNBROKEN RUN of 100-char',
  '  bins by Wilson 95%% upper bound - contiguous because the packer needs one range, upper bound so a',
  '  narrow lucky window cannot win, ties to the WIDER band. But prefer an edge with a CLIFF MARGIN even',
  '  at a slightly worse bound: tr_v3 ranked 400-700 first while the bin below 400 fails 22.9%%, so 500',
  '  is the safer floor. band_chart.py prints that warning.',
  '',
